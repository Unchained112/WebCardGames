    ...
    return(
        <div className="game24start">
            <div className="w3-container w3-center">
                ...
                <div class="w3-content w3-text-white" style="max-width:500px">
                    <p>The 24 game is a simple math game played with poker cards.The player draws four cards from a shuffled deck of cards and find a way to manipulate the four
