    ...
    return(
        <div id="blackjack" >
            ...
            <div class=" w3-content w3-text-white" style="max-width:1000px">    
                ...
                <p>Card face value:</p>
                <p>⑴. 2, 3, 4, 5, 6, 7, 8, 9: Calculate the score according to the actual size of the card.</p>
                <p>⑵. 10. J, Q, K: All scores are calculated based on 10 points.</p>
                <p>⑶. A: There are 2 scoring methods of A, 11 point and 1 point.
                    If A is calculated as 11 points, the total value of the cards in the hand is greater than 21 points; A is calculated as 1 point.</p>
