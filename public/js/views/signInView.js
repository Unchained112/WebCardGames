function SignInView(props){
    return (<div class="w3-container w3-center w3-display-middle w3-card w3-casino-green" style="width:50%">
    ...
    <p><a class="w3-hover-sepia" onClick={r=>{props.goHome();}}>Continue without sign in.</a></p>
    </div>)
}