...
class Ball{
  constructor(){
    this.position.x = 0;
    this.position.y = 0;
    this.img = "assets/images/ball_32_32.png";
    this.w = 32;
    this.h = 32;
  }
}
...
class Paddle{
  constructor(){
    this.position.x = 0;
    this.position.y = 0;
    this.img = "assets/images/paddle_128_32.png";
    this.w = 128;
    this.h = 32;
  }
}
...
class Arkanoid{
  constructor(){
    ...
    this.deck = null;
    this.bricks = null;
    CardSource.getShuffledDecks(1).then(r=>{this.deck = r;});
    CardSource.drawCards(this.deck.deck_id,52).then(r=>{this.bricks = cards});
    this.bricks.cards.forEach(e=>{});
        // ###################################################################
        // Player object
        //
        // ###################################################################
                  ...
                  this.blocks.splice(i, 1);
                    ...
                    if (block.checkCollision()) {
                      ...
                      switch (Math.floor(i / BLOCKS_PER_ROW)) {
                        case 0: points = 7; ball.velocity.y *= 1.1; break;
                        case 1: points = 5; ball.velocity.y *= 1.1; break;
                        case 2:
